...
router.post('/', async (req, res) => {
    let { history,Topic_, difficulty } = req.body;
    ...
    const chatMessages = [
        {
            ...
            parts: [{ text: `You are a moderate debater. Respond clearly and concisely. Your difficulty level is ${difficulty}.In easy mode, allow the user to win by providing a weaker and irrelevant, illogical, and small argument than the user also kinda agree to the user, so that even you think he wins. Don't do so in hard mode, provide the best rebuttal there. in medium mode, it should be average level. Give 1 strong rebuttal only, don't give your thinking or anything else, the current topic is :${Topic_}. It should be of 2-3 lines.` }]
        }
    ];
